...
const MainWallet = ({ username, walletAddresses }: MainWalletProps) => {
  ...
  const cryptoList: Crypto[] = [
    { id: '1', name: 'Tether', symbol: 'USDT', network: 'TRC20', balance: '1,250.00', usdValue: '1,250.00', icon: '₮', address: walletAddresses.get('TRC20') || 'TXYZabcd1234...', color: 'text-green-600' },
    ...
    { id: '3', name: 'Ethereum', symbol: 'ETH', network: 'Ethereum', balance: '1.5432', usdValue: '5,200.00', icon: 'Ξ', address: walletAddresses.get('Ethereum') || '0x742d35...', color: 'text-blue-600' },
    { id: '4', name: 'BNB', symbol: 'BNB', network: 'BSC', balance: '4.23', usdValue: '1,850.00', icon: '🔶', address: walletAddresses.get('BSC') || '0xbnb123...', color: 'text-yellow-600' },
    { id: '5', name: 'Cardano', symbol: 'ADA', network: 'Cardano', balance: '2,450', usdValue: '980.00', icon: '₳', address: walletAddresses.get('Cardano') || 'addr1qxy...', color: 'text-blue-500' },
    { id: '6', name: 'Solana', symbol: 'SOL', network: 'Solana', balance: '12.5', usdValue: '2,750.00', icon: '◎', address: walletAddresses.get('Solana') || 'Sol9vXc...', color: 'text-purple-600' },
    { id: '7', name: 'Ripple', symbol: 'XRP', network: 'XRP Ledger', balance: '5,234', usdValue: '3,140.00', icon: '✕', address: walletAddresses.get('XRP Ledger') || 'rN7n7o...', color: 'text-gray-600' },
    { id: '8', name: 'Polkadot', symbol: 'DOT', network: 'Polkadot', balance: '123.5', usdValue: '987.00', icon: '●', address: walletAddresses.get('Polkadot') || '15oF4u...', color: 'text-pink-600' },
    { id: '9', name: 'Dogecoin', symbol: 'DOGE', network: 'Dogecoin', balance: '15,234', usdValue: '1,520.00', icon: 'Ð', address: walletAddresses.get('Dogecoin') || 'DH5ya...', color: 'text-yellow-500' },
    { id: '10', name: 'Polygon', symbol: 'MATIC', network: 'Polygon', balance: '2,340', usdValue: '2,105.00', icon: '⬡', address: walletAddresses.get('Polygon') || '0xmatic...', color: 'text-purple-500' },
    { id: '11', name: 'Litecoin', symbol: 'LTC', network: 'Litecoin', balance: '8.45', usdValue: '760.00', icon: 'Ł', address: walletAddresses.get('Litecoin') || 'LTC9vXc...', color: 'text-gray-500' },
    { id: '12', name: 'Chainlink', symbol: 'LINK', network: 'Ethereum', balance: '234.5', usdValue: '4,220.00', icon: '⬢', address: walletAddresses.get('Ethereum') || '0xlink...', color: 'text-blue-700' },
    { id: '13', name: 'Avalanche', symbol: 'AVAX', network: 'Avalanche', balance: '45.3', usdValue: '1,810.00', icon: '🔺', address: walletAddresses.get('Avalanche') || 'X-avax...', color: 'text-red-600' },
    { id: '14', name: 'Cosmos', symbol: 'ATOM', network: 'Cosmos', balance: '156.7', usdValue: '1,880.00', icon: '⚛', address: walletAddresses.get('Cosmos') || 'cosmos1...', color: 'text-indigo-600' },
    { id: '15', name: 'Tron', symbol: 'TRX', network: 'Tron', balance: '12,450', usdValue: '1,495.00', icon: '◬', address: walletAddresses.get('Tron') || 'TRX7ya...', color: 'text-red-700' },
    { id: '16', name: 'Monero', symbol: 'XMR', network: 'Monero', balance: '3.45', usdValue: '570.00', icon: 'ɱ', address: walletAddresses.get('Monero') || '47qxy2...', color: 'text-orange-700' },
    { id: '17', name: 'Stellar', symbol: 'XLM', network: 'Stellar', balance: '8,234', usdValue: '987.00', icon: '*', address: walletAddresses.get('Stellar') || 'GAXLM...', color: 'text-cyan-600' },
    { id: '18', name: 'VeChain', symbol: 'VET', network: 'VeChain', balance: '45,234', usdValue: '1,130.00', icon: 'V', address: walletAddresses.get('VeChain') || '0xvet...', color: 'text-blue-800' },
    { id: '19', name: 'Algorand', symbol: 'ALGO', network: 'Algorand', balance: '3,456', usdValue: '1,245.00', icon: '▲', address: walletAddresses.get('Algorand') || 'ALGO7X...', color: 'text-gray-700' },
    { id: '20', name: 'Filecoin', symbol: 'FIL', network: 'Filecoin', balance: '23.4', usdValue: '820.00', icon: '⨎', address: walletAddresses.get('Filecoin') || 'f1abc...', color: 'text-cyan-700' },
    { id: '21', name: 'Hedera', symbol: 'HBAR', network: 'Hedera', balance: '12,345', usdValue: '740.00', icon: 'ℏ', address: walletAddresses.get('Hedera') || '0.0.123...', color: 'text-purple-700' },
    { id: '22', name: 'Near', symbol: 'NEAR', network: 'Near', balance: '567.8', usdValue: '2,270.00', icon: 'N', address: walletAddresses.get('Near') || 'near.xy...', color: 'text-green-700' },
    { id: '23', name: 'Fantom', symbol: 'FTM', network: 'Fantom', balance: '4,567', usdValue: '2,740.00', icon: '👻', address: walletAddresses.get('Fantom') || '0xftm...', color: 'text-blue-900' },
    { id: '24', name: 'Aptos', symbol: 'APT', network: 'Aptos', balance: '89.5', usdValue: '1,610.00', icon: 'A', address: walletAddresses.get('Aptos') || '0xapt...', color: 'text-teal-600' },
    { id: '25', name: 'Optimism', symbol: 'OP', network: 'Optimism', balance: '234.5', usdValue: '705.00', icon: '🔴', address: walletAddresses.get('Optimism') || '0xop...', color: 'text-red-500' },
    { id: '26', name: 'Arbitrum', symbol: 'ARB', network: 'Arbitrum', balance: '1,234', usdValue: '987.00', icon: '🔵', address: walletAddresses.get('Arbitrum') || '0xarb...', color: 'text-blue-600' },
    { id: '27', name: 'Sui', symbol: 'SUI', network: 'Sui', balance: '789.3', usdValue: '1,895.00', icon: '💧', address: walletAddresses.get('Sui') || '0xsui...', color: 'text-cyan-500' },
    { id: '28', name: 'Immutable', symbol: 'IMX', network: 'Ethereum', balance: '456.7', usdValue: '685.00', icon: '⬢', address: walletAddresses.get('Ethereum') || '0ximx...', color: 'text-indigo-700' },
    { id: '29', name: 'Lido DAO', symbol: 'LDO', network: 'Ethereum', balance: '234.8', usdValue: '565.00', icon: '◉', address: walletAddresses.get('Ethereum') || '0xldo...', color: 'text-orange-500' },
    { id: '30', name: 'Toncoin', symbol: 'TON', network: 'TON', balance: '1,234', usdValue: '2,960.00', icon: '💎', address: walletAddresses.get('TON') || 'EQDton...', color: 'text-blue-400' },
  ];
