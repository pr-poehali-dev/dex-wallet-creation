...
const MainWallet = ({ username, walletAddresses }: MainWalletProps) => {
  ...
  const allCryptoList: Crypto[] = useMemo(() => {
    ...
    { id: '1', name: 'Tether (TRC20)', symbol: 'USDT', network: 'TRC20', balance: getBalance('1'), usdValue: '0.00', icon: '₮', iconUrl: 'https://cdn.poehali.dev/files/64ba7feb-f8b0-4f82-8ed8-a8b33c26c00d.png', networkIconUrl: 'https://cryptologos.cc/logos/tron-trx-logo.png', address: tronAddress, color: 'text-green-600' },
    { id: '106', name: 'Tether (ERC20)', symbol: 'USDT', network: 'ERC20', balance: getBalance('106'), usdValue: '0.00', icon: '₮', iconUrl: 'https://cdn.poehali.dev/files/64ba7feb-f8b0-4f82-8ed8-a8b33c26c00d.png', networkIconUrl: 'https://cryptologos.cc/logos/ethereum-eth-logo.png', address: walletAddresses.get('Ethereum') || '0x742d35...', color: 'text-green-600' },
    { id: '107', name: 'Tether (Solana)', symbol: 'USDT', network: 'Solana', balance: getBalance('107'), usdValue: '0.00', icon: '₮', iconUrl: 'https://cdn.poehali.dev/files/64ba7feb-f8b0-4f82-8ed8-a8b33c26c00d.png', networkIconUrl: 'https://cryptologos.cc/logos/solana-sol-logo.png', address: walletAddresses.get('Solana') || 'Sol9vXc...', color: 'text-green-600' },
    { id: '108', name: 'Tether (BEP20)', symbol: 'USDT', network: 'BEP20', balance: getBalance('108'), usdValue: '0.00', icon: '₮', iconUrl: 'https://cdn.poehali.dev/files/64ba7feb-f8b0-4f82-8ed8-a8b33c26c00d.png', networkIconUrl: 'https://cryptologos.cc/logos/bnb-bnb-logo.png', address: walletAddresses.get('BSC') || '0xbnb123...', color: 'text-green-600' },
    { id: '109', name: 'Tether (Polygon)', symbol: 'USDT', network: 'Polygon', balance: getBalance('109'), usdValue: '0.00', icon: '₮', iconUrl: 'https://cdn.poehali.dev/files/64ba7feb-f8b0-4f82-8ed8-a8b33c26c00d.png', networkIconUrl: 'https://cryptologos.cc/logos/polygon-matic-logo.png', address: walletAddresses.get('Polygon') || '0xmatic...', color: 'text-green-600' },
    { id: '110', name: 'Tether (Avalanche)', symbol: 'USDT', network: 'Avalanche', balance: getBalance('110'), usdValue: '0.00', icon: '₮', iconUrl: 'https://cdn.poehali.dev/files/64ba7feb-f8b0-4f82-8ed8-a8b33c26c00d.png', networkIconUrl: 'https://cryptologos.cc/logos/avalanche-avax-logo.png', address: walletAddresses.get('Avalanche') || 'X-avax...', color: 'text-green-600' },
    { id: '111', name: 'USD Coin (ERC20)', symbol: 'USDC', network: 'ERC20', balance: getBalance('111'), usdValue: '0.00', icon: 'C', iconUrl: 'https://cryptologos.cc/logos/usd-coin-usdc-logo.png', networkIconUrl: 'https://cryptologos.cc/logos/ethereum-eth-logo.png', address: walletAddresses.get('Ethereum') || '0xusdc...', color: 'text-blue-600' },
    { id: '112', name: 'USD Coin (Solana)', symbol: 'USDC', network: 'Solana', balance: getBalance('112'), usdValue: '0.00', icon: 'C', iconUrl: 'https://cryptologos.cc/logos/usd-coin-usdc-logo.png', networkIconUrl: 'https://cryptologos.cc/logos/solana-sol-logo.png', address: walletAddresses.get('Solana') || 'Sol9vXc...', color: 'text-blue-600' },
    { id: '113', name: 'USD Coin (BEP20)', symbol: 'USDC', network: 'BEP20', balance: getBalance('113'), usdValue: '0.00', icon: 'C', iconUrl: 'https://cryptologos.cc/logos/usd-coin-usdc-logo.png', networkIconUrl: 'https://cryptologos.cc/logos/bnb-bnb-logo.png', address: walletAddresses.get('BSC') || '0xusdc...', color: 'text-blue-600' },
    { id: '114', name: 'USD Coin (Polygon)', symbol: 'USDC', network: 'Polygon', balance: getBalance('114'), usdValue: '0.00', icon: 'C', iconUrl: 'https://cryptologos.cc/logos/usd-coin-usdc-logo.png', networkIconUrl: 'https://cryptologos.cc/logos/polygon-matic-logo.png', address: walletAddresses.get('Polygon') || '0xusdc...', color: 'text-blue-600' },
    { id: '115', name: 'Dai (ERC20)', symbol: 'DAI', network: 'ERC20', balance: getBalance('115'), usdValue: '0.00', icon: 'D', iconUrl: 'https://cryptologos.cc/logos/multi-collateral-dai-dai-logo.png', networkIconUrl: 'https://cryptologos.cc/logos/ethereum-eth-logo.png', address: walletAddresses.get('Ethereum') || '0xdai...', color: 'text-yellow-600' },
    { id: '116', name: 'Dai (BEP20)', symbol: 'DAI', network: 'BEP20', balance: getBalance('116'), usdValue: '0.00', icon: 'D', iconUrl: 'https://cryptologos.cc/logos/multi-collateral-dai-dai-logo.png', networkIconUrl: 'https://cryptologos.cc/logos/bnb-bnb-logo.png', address: walletAddresses.get('BSC') || '0xdai...', color: 'text-yellow-600' },
  ...
  return (
    <div className="min-h-screen bg-background pb-24 overflow-x-hidden">
      ...
      <div className="px-4 sm:px-6 pt-5 sm:pt-6 space-y-4 relative z-10">
        {activeTab === 'home' && (
          <>
